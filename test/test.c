...
int main()
{
    ...
    // {
    //     FILE *test_db_restaurants = fopen("database/restaurants.txt", "r");
    ...
    //     FILE *test_db_restaurants_copie = fopen("database/restaurants-copie.txt", "w");
    //     ecriture_table_restaurants(test_db_restaurants_copie, &restaurants);
    //     fclose(test_db_restaurants_copie);
    //     TEST_FILE("database/restaurants.txt", "database/restaurants-copie.txt");
